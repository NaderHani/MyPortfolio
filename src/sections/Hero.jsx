...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={topLineRef}
        className="absolute top-24 md:top-32 left-0 w-full px-6 md:px-12 lg:px-24"
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4">
          ...
          <span className="font-body text-[10px] md:text-xs uppercase tracking-[0.2em] text-muted hidden sm:block">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-hidden">
            ...
            >
              ...
              <div
                ref={circleRef}
                className="shrink-0 w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20 rounded-full flex items-center justify-center"
              ...
              >
                <svg viewBox="0 0 100 100" className="w-full h-full">
                  ...
                  <text
                    ...
                    style={{ fontSize: "11.5px", letterSpacing: "2.5px" }}
                  >
                    <textPath href="#cp">
          ...
          {/* Row 3: ALI (outlined) + line */}
          <div className="overflow-hidden">
            <div ref={row3Ref} className="flex items-center gap-4 md:gap-8">
              <h1
                className="font-heading font-extrabold shrink-0"
                style={{
                  ...nameStyle,
      ...
      <div
        ref={bottomRef}
        className="absolute bottom-16 md:bottom-14 left-0 w-full px-6 md:px-12 lg:px-24"
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
          ...
          <a
            ...
            className="group flex items-center gap-3 font-heading text-xs md:text-sm uppercase tracking-[0.15em] text-foreground shrink-0"
            data-hover
          >
            <span className="hover-link">Let&apos;s Connect</span>
            <span
              className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110"
            ...
            >
              <svg
                ...
                stroke="currentColor"
                strokeWidth="2"
                className="text-foreground -rotate-45 group-hover:rotate-0 transition-transform duration-300"
              >
      ...
      >
        <div
          className="w-[1px] h-8 md:h-10 relative overflow-hidden"
          style={{ backgroundColor: "var(--color-border)" }}
        >
          <div
